...
export default function CartPage() {
	...
	return (
		<div className="h-screen flex flex-col ">
			<header className="fixed top-16 left-0 right-0 z-20 m-auto flex justify-center bg-blue-200
			">
				<Link href="/dashboard" className="bg-white px-31.5 py-2	">
					Volver
				</Link>
			</header>

			<article className="flex-1 overflow-y-auto w-full flex flex-col gap-3 py-3 mt-3 z-10">
				{cartItems.map((item) => (
					<section
						key={item.item_id}
						className="w-full flex flex-col items-center px-4 py-2 gap-2 bg-white"
					>
